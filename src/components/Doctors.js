                        ...
                        { doctors &&
                            doctors.map(item=>(
                                <tr key={item.Id}>
                                    ...
                                    <a onClick={()=>{loadAppointment(item.Id)}} className='btn btn-success'>AppointmentAvailable</a>
                                    <a onClick={()=>{loadAppointment(item.Id)}} className='btn btn-success'>Delete</a>
                                    </td>
                                </tr>
